...
import { ArrowLeft, MoreVertical, MessageSquare, Phone, Video, Grid, Film, Image as ImageIcon, PlayCircle, Heart, Share2, MessageCircle, Play, Send, Copy, CheckCircle2, X } from 'lucide-react';
import { motion, AnimatePresence } from 'motion/react';
import { cn } from '@/src/lib/utils';
import { Chat } from '@/src/lib/db';
...
export default function FriendProfileScreen({ friend, onBack, onMessage, onCall }: FriendProfileScreenProps) {
  ...
  const content = {
    reels: [
      { id: 1, thumbnail: 'https://picsum.photos/seed/reel1/200/300', videoUrl: 'https://assets.mixkit.co/videos/preview/mixkit-girl-in-neon-light-1282-large.mp4', views: '1.2k', likes: '458', comments: '24' },
      { id: 2, thumbnail: 'https://picsum.photos/seed/reel2/200/300', videoUrl: 'https://assets.mixkit.co/videos/preview/mixkit-tree-with-yellow-leaves-low-angle-shot-1305-large.mp4', views: '856', likes: '312', comments: '12' },
      { id: 3, thumbnail: 'https://picsum.photos/seed/reel3/200/300', videoUrl: 'https://assets.mixkit.co/videos/preview/mixkit-slow-motion-of-a-woman-with-a-red-smoke-bomb-1241-large.mp4', views: '2.4k', likes: '1.1k', comments: '89' },
    ],
    photos: [
      { id: 1, url: 'https://picsum.photos/seed/photo1/300/300', likes: '124' },
      { id: 2, url: 'https://picsum.photos/seed/photo2/300/300', likes: '89' },
      { id: 3, url: 'https://picsum.photos/seed/photo3/300/300', likes: '256' },
      { id: 4, url: 'https://picsum.photos/seed/photo4/300/300', likes: '42' },
      { id: 5, url: 'https://picsum.photos/seed/photo5/300/300', likes: '167' },
      { id: 6, url: 'https://picsum.photos/seed/photo6/300/300', likes: '310' },
    ],
    videos: [
      { id: 1, thumbnail: 'https://picsum.photos/seed/video1/300/200', videoUrl: 'https://assets.mixkit.co/videos/preview/mixkit-waves-in-the-ocean-1271-large.mp4', duration: '0:45', views: '3.1k', likes: '890' },
      { id: 2, thumbnail: 'https://picsum.photos/seed/video2/300/200', videoUrl: 'https://assets.mixkit.co/videos/preview/mixkit-underwater-shot-of-a-woman-swimming-1240-large.mp4', duration: '1:20', views: '5.4k', likes: '1.2k' },
    ]
  };
